    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('CLOTHING', 'Clothing'), ('ELECTRONICS', 'Electronics'), ('HOME', 'Home'), ('KITCHEN', 'Kitchen'), ('OTHER', 'Other')], max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bidder', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_bid', to=settings.AUTH_USER_MODEL)),
